...
int main(int argc, char **argv) {
    ...
    const char *out = (argc > 3) ? argv[3] : "build/output/data3_part2";
    ...
    for (size_t i = 0; i < N * N; ++i) mat3[i] = 0.0;

    double t0 = now_seconds();
    matmul_rows(mat1, mat2, mat3, N, 0, 500);
    matmul_rows(mat1, mat2, mat3, N, 500, 1000);
    ...
    fprintf(stderr, "Multiply time (Part 2): %.6f seconds\n", elapsed);
